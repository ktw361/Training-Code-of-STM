...
if __name__ == "__main__":
    ...
    Testloader = DAVIS_MO_Test(DATA_ROOT, resolution='480p', imset='20{}/{}.txt'.format(YEAR,SET), single_object=(YEAR==16),direction_m=True)
    print(evaluate(model,Testloader,metric,SET))

    Testloader = DAVIS_MO_Test(DATA_ROOT, resolution='480p', imset='20{}/{}.txt'.format(YEAR,SET), single_object=(YEAR==16),direction_m=False)
    print(evaluate(model,Testloader,metric,SET))
